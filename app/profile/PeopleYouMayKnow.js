...
//               <ProfileAvatar name={person.name} image={person.avatar || person.profilePhoto} />
//               <div>
        ...
        {list.map((person) => (
          <div key={person.id} className="border-b border-gray-800 pb-4">
            <div className="flex items-center gap-3">
              ...
              <Link href={`/${person.id}`} className="flex items-center gap-3">
                <ProfileAvatar name={person.name} image={person.avatar || person.profilePhoto} />
                <div>
            ...
            <div className="mt-3">
              {/* simple connect button (replace with your Button component if you want) */}
              <button className="w-full text-white bg-blue-600 hover:bg-blue-700 rounded-lg py-2 text-sm">
                Connect
              </button>
            </div>
          </div>
