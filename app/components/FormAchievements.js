...
//           <InputWithCount
//             value={input}
//             onChange={(val) => setInput(val)} // ✅ direct string
...
//             <div
//               key={idx}
//               className="flex items-center gap-2 px-3 py-1 bg-gray-100 border border-gray-200 rounded-full"
//             >
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          {visibleItems.map((item, idx) => (
            <div
              key={idx}
              className="flex items-center gap-2 px-3 py-1  border border-gray-200 rounded-full"
            >
