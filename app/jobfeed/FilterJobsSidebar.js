...
//   // 📌 whenever filters change → auto apply
//   useEffect(() => {
//     const isModified = JSON.stringify(filters) !== JSON.stringify(initialFilters);
//     setApplied(isModified);
//     if (isModified && onApplyFilters) {
//       onApplyFilters(filters);
//     }
//   }, [filters]);

//   // 📌 reusable text/select handler
...
//     setApplied(false);
//     if (onClearFilters) onClearFilters(initialFilters);
//   };

//   // 📌 Suggestions filtering (auto-complete)
...
//   return (
//     <div className="w-72 bg-white shadow-lg rounded-2xl p-5 h-fit border border-gray-200">
